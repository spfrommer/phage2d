package examples.tankarena.multi;
...
public class ArenaClient extends Client {
	...
	public InputManager createInputManager(final int id) {
		...
		addNetworkBinding(inputManager, new KeyTrigger(keyboard.getKey('w')), "Forwards", "inputforwards", id);
		addNetworkBinding(inputManager, new KeyTrigger(keyboard.getKey('s')), "Backwards", "inputbackwards", id);
		addNetworkBinding(inputManager, new KeyTrigger(keyboard.getKey('a')), "Left", "inputleft", id);
		addNetworkBinding(inputManager, new KeyTrigger(keyboard.getKey('d')), "Right", "inputright", id);
